...
sys.path.append("../input/pytorch-pretrained-bert-xlnet/pytorch-pretrained-bert-xlnet/pytorch-pretrained-BERT-xlnet")
from pytorch_pretrained_bert_xlnet import XLNetTokenizer, XLNetForClassification, BertAdam, XLNetConfig
...
config = XLNetConfig('../input/xlnet-weights/cased_l-24_h-1024_a-16/xlnet_cased_L-24_H-1024_A-16/xlnet_config.json')
...
exp = "exp13_xlnet"
model_path = "../input/xlnet-weight/exp13_xlnet_epoch0_fold{}.pth".format(fold_id)
seed_torch(seed)
...
def main():
    ...
    with timer('train'):
        ...
        model = XLNetForClassification.from_pretrained("xlnet-large-cased", cache_dir=None, clf_dropout=0.4,
                                                       n_class=n_labels)
