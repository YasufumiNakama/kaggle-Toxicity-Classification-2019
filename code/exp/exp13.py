...
from pytorch_pretrained_bert_xlnet import XLNetTokenizer, XLNetForClassification, BertAdam
...
def main():
    ...
    with timer('load embedding'):
        ...
        X_text = convert_lines_gpt2_head_tail(train_df["comment_text"].fillna("DUMMY_VALUE"), max_len,
                                              head_len, tokenizer)
