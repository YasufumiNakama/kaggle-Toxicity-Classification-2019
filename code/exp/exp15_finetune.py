...
bert_config = BertConfig('../input/exp15-weights/bert_config.json')
...
exp = "exp15_bert_base_multi_cased"
model_path = "../input/toxic-tmp/exp15_bert_base_multi_cased_epoch0_fold{}.pth".format(fold_id)
seed_torch(seed)
